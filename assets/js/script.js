...
<!-- Submit -->
<button class="btn btn-teal btn-full btn-lg" style="opacity:${f.title.trim()&&f.desc.trim()?'1':'0.5'};margin-top:8px" onclick="submitIdeaPost()">🎯 Submit for Pressure Testing →</button>
...
document.getElementById('checkout-content').innerHTML=`
  ...
  <div class="card checkout-form-card">
    ...
    <button class="btn btn-teal btn-full btn-lg" style="margin-top:8px;opacity:${c.name.trim()&&c.email.trim()?'1':'0.5'}" onclick="submitCheckoutForm()">🔒 Pay $5 — Join Early Access</button>
